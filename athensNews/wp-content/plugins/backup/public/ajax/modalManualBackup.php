...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <?php if ($backupType == SG_BACKUP_METHOD_MIGRATE && !SGBoot::isFeatureAvailable('BACKUP_WITH_MIGRATION')): ?>
            <p> <div class="sg-feature-alert-text"> *<?php echo SG_SILVER_TOOLTIP_TEXT ?> </div> </p>
                                        ...
                                        <?php if(SGBoot::isFeatureAvailable('AMAZON')): ?>
                                            <div class="checkbox">
                                                <label for="cloud-amazon" <?php echo empty($amazon)?'data-toggle="tooltip" data-placement="right" title="'._backupGuardT((backupGuardIsAccountGold()? 'Amazon ':'').'S3 is not active.',true).'"':''?>>
                                                    ...
                                                    <?php _backupGuardT((backupGuardIsAccountGold()? 'Amazon ':'').'S3'); ?>
                                                </label>
                                            </div>
                                        <?php endif; ?>
